...
if(isset($_POST['konfirmasi'])){
  ubah_profil($data['id_petugas'], $_POST['nama_petugas'], $_POST['telp'], $_POST['konfirmasi_pass']);
}
if(isset($_POST['ubah_pass'])){
  ubah_pass($data['id_petugas'], $_POST['pass1'], $_POST['pass2'], $mantap['pa'], $_POST['pass_now']);
}
$sql = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM petugas WHERE id_petugas='$data[id_petugas]'"));
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="col-lg">
                <div class="p-5">
                  ...
                  <div class="form-group">
                      ...
                      <input value="<?php echo $sql['password'];?>" type="text" name="pa" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan Password" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="submit" name="ubah_pass" value="Konfirmasi" class=" btn btn-primary btn-block">
<?php
                ...
                <div class="p-5">
                  ...
                  <form method="POST" action="">
                    <div class="form-group">
                      ...
                      <input required="required" type="text" name="nama_petugas" class="form-control form-control-user" id="exampleInputEmail" value="<?= $sql['nama_petugas'];?>" aria-describedby="emailHelp" placeholder="Nama Petugas">
                    </div>
                    <div class="form-group">
                    ...
                    <input type="submit" name="konfirmasi" value="Konfirmasi" class=" btn btn-primary btn-block">
<?php
if(isset($_GET['berhasil'])){
  if($_GET['berhasil']=="keynotvalid"){
?>
