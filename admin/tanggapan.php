...
if(isset($_GET['tanggapi'])){
  $idp = $_GET['tanggapi'];
  $outdatatanggapan = mysqli_query($koneksi, "SELECT * FROM pengaduan inner join masyarakat ON pengaduan.nik=masyarakat.nik where id_pengaduan='$idp'");
...
if(isset($_POST['tanggapi'])){
  tanggapi($datap['id_pengaduan'], htmlspecialchars($_POST['tanggapan']), $datap['nik'], $datap['nama'], $data['nama_petugas']);
}
?>
<!DOCTYPE html>
<html lang="en">
