...
<?php
  $proses = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM pengaduan WHERE status='proses' and nik='$_SESSION[nik]'"));
  $belumditanggapi = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM pengaduan WHERE status='0' and nik='$_SESSION[nik]'"));
  $selesai = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM pengaduan WHERE status='selesai' and nik='$_SESSION[nik]'"));
  $jumlah = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM pengaduan WHERE nik='$_SESSION[nik]'"));
  if(empty($jumlah)){
    error_reporting(0);
  }
?>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="progress mb-4">
                    <div class="progress-bar animated--grow-in bg-warning" role="progressbar" style="width: <?= $persenbelumditanggapi."%";?>" aria-valuenow="<?= $persenbelumditanggapi."%";?>" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
