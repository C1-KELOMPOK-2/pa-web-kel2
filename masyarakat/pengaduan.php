...
if(isset($_POST['pengaduan'])){
  ...
  $target = '../uploads/'.$_FILES['gambar']['name'];
  if(isset($_FILES['gambar'])){
      move_uploaded_file($pathh, $target);
      ajukan($_SESSION['nik'], $_FILES['gambar']['tmp_name'], $_FILES['gambar']['name'], $_POST['isi']);
    }else{
                ...
                <div class="p-5">
                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    <div class="form-group">
                      <small>NIK</small>
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" readonly="readonly" value="<?= $_SESSION['nik'];?>" placeholder="NIK">
                    </div>
                    <hr/>
                    <div class="form-group">
